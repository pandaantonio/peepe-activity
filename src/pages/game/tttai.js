...
export default function TicTacToe() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#ededed] select-none font-sans antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-center z-10 relative overflow-hidden">
        <div className="w-full flex flex-col lg:grid lg:grid-cols-12 gap-4 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-4 order-2 lg:order-1">
            ...
            {/* Card do Placar - CSS fixo inline */}
            <div className="rounded-2xl p-4 sm:p-6 shadow-2xl" style={{
          ...
          <div className="lg:col-span-7 flex flex-col justify-center relative order-1 lg:order-2">
            ...
            {/* Card do Tabuleiro - CSS fixo inline */}
            <div className="rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl relative" style={{
              background: 'rgba(255, 255, 255, 0.03)',
              backdropFilter: 'blur(20px)',
              WebkitBackdropFilter: 'blur(20px)',
              border: '1px solid rgba(255, 255, 255, 0.06)',
              ...
              <div className="w-full max-w-[min(92vw,550px)] mx-auto">
                <div className="grid grid-cols-3 gap-2.5 sm:gap-3 md:gap-4 p-3 sm:p-4 rounded-2xl bg-[#050507]/50 border border-white/5 shadow-inner aspect-square">
              ...
              {(winner || isDraw) && (
                <div className="absolute inset-0 bg-[#0a0a0c]/95 rounded-2xl flex flex-col items-center justify-center gap-4 p-6 sm:p-8 z-20 border border-white/10" style={{animation: 'fadeIn 0.25s ease-out forwards'}}>
      ...
      {/* Estilos CSS Corrigidos - Agora com @keyframes válidos */}
      <style jsx>{`
        @keyframes scaleUp {
          from { 
            opacity: 0; 
