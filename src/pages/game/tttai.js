  ...
  return (
    <button
      ...
      className={`
        ...
        text-[clamp(1.5rem,6vw,3rem)] sm:text-[clamp(2rem,6vh,4.5rem)] font-black
        ...
        ${isWinning ? '!bg-emerald-500/10 !border-emerald-500/40 shadow-[0_0_25px_rgba(52,211,153,0.25)]' : ''}
        ${isLastMove && !isWinning ? 'ring-2 ring-white/10' : ''}
        disabled:cursor-not-allowed
      `}
    >
      {cell === 'X' && (
        <span className="text-emerald-400 drop-shadow-[0_0_12px_rgba(52,211,153,0.4)] animate-scaleUp text-2xl sm:text-4xl md:text-5xl">
          X
        </span>
      )}
      {cell === 'O' && (
        <span className="text-rose-400 drop-shadow-[0_0_12px_rgba(244,63,94,0.4)] animate-scaleUp text-2xl sm:text-4xl md:text-5xl">
          O
        </span>
      )}
    </button>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#ededed] select-none font-sans antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="bg-white/[0.02] backdrop-blur-xl border-b border-white/5 shrink-0 z-10 relative">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row gap-3 sm:gap-0 sm:items-center sm:justify-between">
          ...
          <div className="flex-1 flex justify-center order-2 sm:order-2">
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.02] border border-white/10 text-xs sm:text-sm font-bold uppercase tracking-wider text-center">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-center z-10 relative overflow-hidden">
        <div className="w-full flex flex-col lg:flex-row gap-4 lg:gap-8 items-center lg:items-stretch">

          {/* COLUNA ESQUERDA: Placar */}
          <div className="w-full lg:w-1/3 xl:w-1/4 flex flex-col justify-between rounded-2xl p-4 sm:p-6 shadow-2xl gap-4" style={{
            ...
            <div className="bg-[#050507]/50 rounded-2xl p-4 sm:p-6 border border-white/5 shadow-inner">
          ...
          <div className="flex-1 flex flex-col justify-center rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl relative" style={{
            background: 'rgba(255, 255, 255, 0.03)',
            backdropFilter: 'blur(20px)',
            WebkitBackdropFilter: 'blur(20px)',
            border: '1px solid rgba(255, 255, 255, 0.06)',
            ...
            <div className="w-full max-w-[min(70vh,500px)] mx-auto">
              <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 rounded-2xl bg-[#050507]/50 border border-white/5 shadow-inner aspect-square p-3 sm:p-4">
            ...
            {(winner || isDraw) && (
              <div className="absolute inset-0 bg-[#0a0a0c]/95 backdrop-blur-md rounded-2xl flex flex-col items-center justify-center gap-4 p-6 sm:p-8 z-20 border border-white/10" style={{animation: 'fadeIn 0.25s ease-out forwards'}}>
