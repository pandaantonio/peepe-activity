...
export default function TicTacToeEasy() {
  ...
  // LÓGICA DO MODO FÁCIL: 85% de chance de errar voluntariamente
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      let move;
      if (Math.random() < 0.85) {
        // Escolha completamente aleatória (IA boba)
        const randomIndex = Math.floor(Math.random() * emptyCells.length);
        move = emptyCells[randomIndex];
      } else {
        // 15% de chance de fazer a jogada certa
  ...
  const getStatusText = () => {
    ...
    return "IA CALCULANDO VETORES SIMPLES...";
  };
        ...
        <div className={styles.gameLayout}>
          ...
          <div className={`${styles.scoreCard} ${styles.glassCard}`}>
            <div className={styles.scoreHeader}>
              <span className={styles.scoreLabel}>MODO FÁCIL Ativo</span>
            ...
            <div className={styles.scorePanel}>
              <div className={styles.scoreGrid}>
                ...
                <div className={styles.scoreItem}>
                  ...
                  <span className={styles.scoreLabelText}>IA Boba (O)</span>
              ...
              <div className={styles.progressBar}>
                ...
                <div className={styles.progressAI} style={{ width: `${totalGames > 0 ? (scores.ai / totalGames) * 100 : 33.3}%` }} />
              </div>
            </div>
            ...
            <div className={styles.tipCard}>
              ...
              <div className={styles.tipContent}>
                ...
                <p className={styles.tipText}>
                  A IA está operando com buffers reduzidos. Erros frequentes detectados.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className={styles.overlay}>
                ...
                <div className={styles.overlayContent}>
                  ...
                  <p className={styles.overlayText}>
                    {winner === 'X' && 'Você superou os sub-sistemas enfraquecidos da IA.'}
                    {winner === 'O' && 'Mesmo limitando as funções, a IA conseguiu achar uma brecha.'}
                    {isDraw && 'Sistemas em perfeito equilíbrio de redundância.'}
                  </p>
                </div>
